...
import { CheckCircle, Star, Award, Users, Target, Heart, Shield, Zap } from "lucide-react";
...
const AboutPage = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Hero Section */}
      <section className="py-20 bg-secondary/20 mt-16">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="text-3xl lg:text-4xl font-bold mb-6">
                <span className="text-foreground">Referência em </span>
      ...
      <section className="py-20 bg-secondary/20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl lg:text-4xl font-bold mb-6">
              <span className="text-foreground">A base de tudo </span>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h2 className="text-3xl lg:text-4xl font-bold mb-8">
              <span className="text-foreground">Mais que um negócio, </span>
